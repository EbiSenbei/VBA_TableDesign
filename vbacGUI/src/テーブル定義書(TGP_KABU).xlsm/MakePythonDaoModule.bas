...
Private Sub outputPythonDao(ByRef tTbl As typeTable, ByRef arrColumn() As typeColumn)
On Error GoTo Err0
    'アクティブなシートを取得する。
...
Private Function outputPythonDao_Insert(ByRef tTbl As typeTable, ByRef arrColumn() As typeColumn) As String
On Error GoTo Err0
...
Private Function outputPythonDao_Update(ByRef tTbl As typeTable, ByRef arrColumn() As typeColumn) As String
On Error GoTo Err0
...
Private Function outputPythonDao_Push(ByRef tTbl As typeTable, ByRef arrColumn() As typeColumn) As String
On Error GoTo Err0
...
Private Function outputPythonDao_Delete(ByRef tTbl As typeTable, ByRef arrColumn() As typeColumn) As String
On Error GoTo Err0
...
Private Function outputPythonDao_Select(ByRef tTbl As typeTable, ByRef arrColumn() As typeColumn) As String
On Error GoTo Err0
